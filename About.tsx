  ...
  return (
    <div className="px-6 py-12 max-w-5xl mx-auto space-y-32 pb-40">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-10">
        <div className="reveal reveal-delay-1 border border-black/5 dark:border-white/5 p-12 rounded-[2rem] bg-neutral-50 dark:bg-card-dark relative overflow-hidden group hover:border-primary/20 transition-all duration-500">

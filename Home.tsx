    ...
    <div className="px-6 pb-32 max-w-7xl mx-auto overflow-hidden">
      ...
      <section className="mb-32">
        <div className="flex items-end justify-between mb-16 reveal">
          ...
          <button onClick={() => onNavigate('free')} className="text-xs font-bold uppercase tracking-widest text-primary hover:text-primary/70 transition-colors pb-1 border-b border-primary/20">
            View Library
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          {[
            ...
            <div key={idx} className={`group cursor-pointer reveal reveal-delay-${idx+1}`} onClick={() => onNavigate('free')}>

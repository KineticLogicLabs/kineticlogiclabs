...
const FreeResources: React.FC<FreeResourcesProps> = ({ onNavigate }) => {
    ...
    <div className="px-6 py-12 max-w-5xl mx-auto pb-40">
      ...
      <section className="bg-primary/5 border border-primary/10 rounded-[2.5rem] p-12 md:p-20 text-center reveal mt-20">
        <div className="max-w-xl mx-auto">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-6 tracking-tight text-black dark:text-white">Need advanced logic?</h2>
          <p className="text-black/50 dark:text-white/50 mb-10 text-sm leading-relaxed font-normal">
            Our premium assets include verified sub-assemblies and complete gearbox templates for high-stakes competition.
          </p>
          <button 

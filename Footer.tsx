...
const Footer: React.FC<FooterProps> = ({ onNavigate }) => {
  return (
    <footer className="bg-neutral-50 dark:bg-black border-t border-black/5 dark:border-white/5 pt-16 pb-12 px-8 transition-colors duration-300">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
        ...
        <div className="grid grid-cols-2 gap-8 md:justify-items-center">
          <div className="flex flex-col gap-4">
            ...
            <button onClick={() => onNavigate('free')} className="text-black/40 dark:text-white/40 text-[11px] uppercase tracking-widest font-bold hover:text-primary dark:hover:text-white text-left">Free</button>
            <button onClick={() => onNavigate('paid')} className="text-black/40 dark:text-white/40 text-[11px] uppercase tracking-widest font-bold hover:text-primary dark:hover:text-white text-left">Premium</button>
          </div>
          <div className="flex flex-col gap-4">

...
const PaidResources: React.FC<PaidResourcesProps> = ({ onAddToCart, onNavigate }) => {
    ...
    <div className="px-6 py-12 max-w-7xl mx-auto pb-40">
      <div className="text-center mb-24 reveal">
        ...
        <p className="text-black/40 dark:text-white/40 text-base md:text-lg max-w-xl mx-auto leading-relaxed">
          High-performance modules designed for the final stages of your mission build. All transactions are handled securely via Stripe.
        </p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
        {PREMIUM_ASSETS.map((item, idx) => (
          <div key={item.id} className={`bg-neutral-50 dark:bg-card-dark border border-black/5 dark:border-white/5 rounded-[2.5rem] overflow-hidden flex flex-col group hover:border-primary/20 transition-all duration-500 reveal reveal-delay-${idx}`}>
